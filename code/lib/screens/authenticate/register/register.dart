...
class _RegisterState extends State<Register> {
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).translate('Sign Up')),
        elevation: 0.0,
        centerTitle: true,
          ...
          key: _formKey,
            child: Column(
                  ...
                  child: RaisedButton(
                    onPressed: () async{
                      if(_formKey.currentState.validate()) {
                        ...
                        if (result == null) {
                          setState(() {
                            error = AppLocalizations.of(context).translate('Invalid Email');
                            loading = false;
                          });
                        }
                        Navigator.of(context).pop();
              ...
              InkWell(
                ...
                child: Text(
                  AppLocalizations.of(context).translate('Click here to Sign In'),
                  style: TextStyle(
                    fontSize: 18,
                    color: Colors.black,
                  ),
